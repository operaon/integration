# Contrato do módulo — integration

Este documento resume o contrato local de integration. O contrato transversal de headers e webhooks está em [communication-contract.md](communication-contract.md).
